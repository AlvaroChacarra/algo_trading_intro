...
- **Puente:** "mirad vuestras firmas: `best_bid(book)`, `add_order(book, …)` — el dato por un lado, las funciones por otro, y vosotros de repartidores. En L4 nacen `Order` y `Fill`; en L5 el libro también se vuelve objeto y la métrica sin argumentos se lee como property: `book.best_bid`."
