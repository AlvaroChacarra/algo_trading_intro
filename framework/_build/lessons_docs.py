...
DOCS = {
1: {
"theory": """Ejecutar código es solo esto: un programa (el intérprete de Python) lee texto, lo
...
"technical": """Sin paquete todavía: se trabaja con tipos básicos (`int`, `float`, `str`), listas,
