...
const SlideMasterValue = () => {
  ...
  const data = useMemo(() => Array.from({ length: 11 }, (_, i) => {
      const baseSalary = 24000 * Math.pow(1.03, i);
      const masterSalary = (24000 * 1.15) * Math.pow(1.03 + (0.02 * signaling), i);
      return {
        year: `Año ${i}`,
      ...
      <div className="col-span-12 md:col-span-3 flex flex-col gap-4">
        ...
        <Card title="Junior Insight" icon={AlertTriangle} className="bg-amber-500/5 border-amber-500/20">
          ...
          <p className="text-xs text-slate-400 leading-relaxed">
            Las empresas saben que no sabes. Te contratan por tu <span className="text-white">pendiente de aprendizaje</span> (lo rápido que aprenderás), no por tu conocimiento actual.
          </p>
        </Card>
      </div>
  ...
  return (
    <div className="h-full grid grid-cols-12 gap-4">
      <div className="col-span-12 md:col-span-4 flex flex-col gap-3">
        ...
        <div onClick={() => setSelected('consulting')} className={`cursor-pointer p-4 rounded-xl border transition-all ${selected === 'consulting' ? 'bg-blue-900/20 border-blue-500 ring-1 ring-blue-500/50' : 'bg-slate-900 border-slate-800 hover:border-slate-700'}`}>
        ...
        <div onClick={() => setSelected('corporate')} className={`cursor-pointer p-4 rounded-xl border transition-all ${selected === 'corporate' ? 'bg-green-900/20 border-green-500 ring-1 ring-green-500/50' : 'bg-slate-900 border-slate-800 hover:border-slate-700'}`}>
          <div className="flex items-center gap-3">
        ...
        <div onClick={() => setSelected('abroad')} className={`cursor-pointer p-4 rounded-xl border transition-all ${selected === 'abroad' ? 'bg-orange-900/20 border-orange-500 ring-1 ring-orange-500/50' : 'bg-slate-900 border-slate-800 hover:border-slate-700'}`}>
          <div className="flex items-center gap-3">
          ...
          <div className="flex flex-col h-full">
            ...
            <div className="grid grid-cols-2 gap-8 flex-1">
                ...
                {details[selected].stats.map((stat, i) => (
                  <div key={i}>
                    ...
                    <div className="h-2 w-full bg-slate-800 rounded-full overflow-hidden">
                      <div className={`h-full rounded-full transition-all duration-700 ${stat.val > 80 ? 'bg-green-500' : stat.val > 50 ? 'bg-blue-500' : 'bg-red-500'}`} style={{ width: `${stat.val}%` }} />
                    </div>
                  </div>
                ))}
              </div>
              ...
              <div className="bg-slate-950 p-6 rounded-xl border border-slate-800 flex flex-col justify-center">
                ...
                <p className="text-slate-300 text-sm leading-relaxed italic">"{details[selected].reality}"</p>
              </div>
            </div>
          </div>
        </Card>
      ...
      <div className="col-span-12 md:col-span-4 flex flex-col gap-4">
        ...
        <Card title="Networking Multiplier" className="bg-blue-900/10 border-blue-500/20">
             <p className="text-xs text-blue-200 leading-relaxed">
                 <span className="font-bold">Pro Tip Junior:</span> Contactar a un ex-alumno por LinkedIn multiplica x10 tus chances de entrevista.
             </p>
        </Card>
      </div>
      <div className="col-span-12 md:col-span-8">
                ...
                <li className="flex items-start gap-3">
                    ...
                    <div>
                        ...
                        <p className="text-xs text-slate-400 mt-1">
                            {mode==='good' ? "1 Página estricta. Fuerza a priorizar lo relevante." : "2-3 Páginas. Incluye experiencias irrelevantes."}
                        </p>
                    </div>
                </li>
                <li className="flex items-start gap-3">
        ...
        <Card className="bg-slate-950 border-dashed border-slate-800 flex items-center justify-center">
            <div className="text-center">
                 ...
                 <p className="text-sm text-slate-300">
                     ¿Sin experiencia? Usa tus <span className="text-blue-400">Proyectos de Máster</span> como experiencia laboral.
                 </p>
            </div>
        </Card>
      </div>
                ...
                <div className="space-y-4 mt-2">
                    <div className="flex gap-4 items-start p-3 rounded bg-slate-950 border border-slate-800">
                        ...
                        <div>
                            ...
                            <p className="text-xs text-slate-500">Si buscas roles técnicos o de ingeniería.</p>
                        </div>
                    </div>
                    <div className="flex gap-4 items-start p-3 rounded bg-slate-950 border border-slate-800">
                        ...
                        <div>
                            ...
                            <p className="text-xs text-slate-500">Agregador de Graduate Programs.</p>
                        </div>
                    </div>
                    <div className="flex gap-4 items-start p-3 rounded bg-slate-950 border border-slate-800">
                        ...
                        <div>
                            ...
                            <p className="text-xs text-slate-500">Usa: <code>"Graduate" AND "Analyst"</code></p>
                        </div>
                    </div>
                </div>
            </Card>
