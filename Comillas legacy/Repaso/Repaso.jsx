...
import { 
  ArrowRight, ArrowLeft, Play, Pause, RefreshCw, TrendingUp, BarChart3, Zap, Cpu, Layers, Target, Activity, DollarSign, Scale, AlertTriangle, Lightbulb, Eye, Anchor, BookOpen, GitBranch, Users, History, Rocket, Bot, Brain, Code, Sparkles 
} from 'lucide-react';
      ...
      columns: [
        ...
        { 
            ...
            points: [
                ...
                { highlight: "Gemini 2.5 Pro", text: "De Google. Ventana de contexto masiva (1M tokens), ideal para analizar codebases grandes de un vistazo." },
                { highlight: "OpenAI o1 / Codex", text: "Modelos especializados en código con capacidad de razonamiento paso a paso ('chain of thought')." }
            ] 
        },
        { 
