# Clase 8 — El framework: Strategy + Backtest (guía de implementación)
...
Tiers: **Núcleo** = los primeros (en clase), **Si vamos bien** = el resto, **Auxiliares** = cuaderno `08_auxiliary.ipynb`.
