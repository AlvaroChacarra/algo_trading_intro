# Clase 4 — OOP II — OrderBook y PositionTracker (guía de implementación)
...
Tiers: **Núcleo** = ej. 1-3 (en clase), **Si vamos bien** = resto, **Auxiliares** = cuaderno `04_auxiliary.ipynb`.
